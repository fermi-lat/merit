//
// File generated by C:\GLAST\Ground\tools\GLAST_external\ROOT\3.01.06\bin\rootcint at Tue Dec 18 20:03:46 2001.
...
static int G__FigureOfMerit_execute_2_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FigureOfMerit*)(G__getstructoffset()))->execute());
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__meritFoM_numTupleEvents_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((meritFoM*)(G__getstructoffset()))->numTupleEvents());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_cutEvent_5_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((meritFoM*)(G__getstructoffset()))->cutEvent((int)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_getAnalysisListSize_6_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((meritFoM*)(G__getstructoffset()))->getAnalysisListSize());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_getAnalysisListItem_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((meritFoM*)(G__getstructoffset()))->getAnalysisListItem((int)G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_getAnalysisList_8_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((meritFoM*)(G__getstructoffset()))->getAnalysisList());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_Class_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((meritFoM*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_Class_Name_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((meritFoM*)(G__getstructoffset()))->Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_Class_Version_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((meritFoM*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_Dictionary_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((meritFoM*)(G__getstructoffset()))->Dictionary();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_IsA_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const meritFoM*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_ShowMembers_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((meritFoM*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_Streamer_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((meritFoM*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_StreamerNVirtual_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((meritFoM*)(G__getstructoffset()))->StreamerNVirtual(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_DeclFileName_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((meritFoM*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_DeclFileLine_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((meritFoM*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_ImplFileName_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((meritFoM*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__meritFoM_ImplFileLine_3_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((meritFoM*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__meritFoM_meritFoM_4_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   meritFoM *p;
...
static int G__meritFoM_wAmeritFoM_5_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
...
"u 'Tuple' - 11 - t u 'string' - 0 \"\" cutstring",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("execute",755,G__FigureOfMerit_execute_2_0,105,G__get_linked_tagnum(&G__MeritCintLN_bool),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
...
"C - - 10 - fileName C - - 10 - cutstring",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("numTupleEvents",1487,G__meritFoM_numTupleEvents_4_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("cutEvent",846,G__meritFoM_cutEvent_5_0,105,G__get_linked_tagnum(&G__MeritCintLN_bool),-1,0,1,1,1,0,"i - - 0 - idx",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getAnalysisListSize",1979,G__meritFoM_getAnalysisListSize_6_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getAnalysisListItem",1967,G__meritFoM_getAnalysisListItem_7_0,85,G__get_linked_tagnum(&G__MeritCintLN_Analyze),-1,0,1,1,1,0,"i - - 0 - i",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("getAnalysisList",1568,G__meritFoM_getAnalysisList_8_0,85,G__get_linked_tagnum(&G__MeritCintLN_AnalysisList),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("Class",502,G__meritFoM_Class_2_1,85,G__get_linked_tagnum(&G__MeritCintLN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Name",982,G__meritFoM_Class_Name_3_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__meritFoM_Class_Version_4_1,115,-1,G__defined_typename("Version_t"),0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Dictionary",1046,G__meritFoM_Dictionary_5_1,121,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__meritFoM_IsA_6_1,85,G__get_linked_tagnum(&G__MeritCintLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__meritFoM_ShowMembers_7_1,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__meritFoM_Streamer_8_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("StreamerNVirtual",1656,G__meritFoM_StreamerNVirtual_9_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__meritFoM_DeclFileName_0_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__meritFoM_DeclFileLine_1_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__meritFoM_ImplFileName_2_2,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__meritFoM_ImplFileLine_3_2,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("meritFoM",803,G__meritFoM_meritFoM_4_2,(int)('i'),G__get_linked_tagnum(&G__MeritCintLN_meritFoM),-1,0,1,1,1,0,"u 'meritFoM' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~meritFoM",929,G__meritFoM_wAmeritFoM_5_2,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   G__tag_memfunc_reset();
}
