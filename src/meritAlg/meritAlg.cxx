...
StatusCode meritAlg::initialize() {
  ...
  new TupleItem("FT1Energy",            &m_ft1energy);
  new TupleItem("FT1Theta",             &m_ft1theta);
  new TupleItem("FT1Phi",               &m_ft1phi);
  new TupleItem("FT1Ra",                &m_ft1ra);
  new TupleItem("FT1Dec",               &m_ft1dec);
  new TupleItem("FT1ZenithTheta",       &m_ft1zen);
  new TupleItem("FT1EarthAzimuth",      &m_ft1azim);
  new TupleItem("FT1ConvPointX",        &m_ft1convpointx);
