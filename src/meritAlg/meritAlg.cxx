...
$Header: /nfs/slac/g/glast/ground/cvs/merit/src/meritAlg/meritAlg.cxx,v 1.97 2005/11/09 16:49:02 burnett Exp $
*/
// Include files
...
</td><td>     High 17 bits of the filter status word 
</td></tr>
<tr><td>  FilterStatus_LO
</td><td>    low 15 bits of the filter status word 
</td></tr>
...
void meritAlg::printOn(std::ostream& out)const{
    out << "Merit tuple, " << "$Revision: 1.97 $" << std::endl;
