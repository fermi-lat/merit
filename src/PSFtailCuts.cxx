// $Header: /nfs/slac/g/glast/ground/cvs/merit/src/PSFtailCuts.cxx,v 1.8 2003/05/28 00:13:53 burnett Exp $
...
#if 0 // old version
    push_back( new Cut(t, "IMcoreProb>0.9") );
    push_back( new Cut(t, "IMpsfErrPred<5.0") );
#else // new (v3) version
